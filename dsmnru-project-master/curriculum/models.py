...
class Lesson(models.Model):
    ...
    position = models.PositiveSmallIntegerField(verbose_name="Unit no.")
    slug = models.SlugField(null=True, blank=True)
    ...
    def get_absolute_url(self):
        return reverse('curriculum:lesson_list', kwargs={'slug':self.subject.slug, 'department':self.Department.slug})
